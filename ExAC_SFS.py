...
vcf_reader = vcf.Reader(open("C:/Users/raman/Downloads/ExAC.r1.sites.vep.vcf", 'r'))
...
for record in vcf_reader:
    ...
    afr_allele_number = record.INFO["AN_AFR"]
    if afr_ac != 0:
    ...
    if func_con in consequences:
            ...
            if afr_freq != 'undefined':
                afr_frequencies[func_con].append(afr_freq)
